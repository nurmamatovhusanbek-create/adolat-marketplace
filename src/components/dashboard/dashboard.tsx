        ...
        <div className="p-6">
          ...
          {user && (
            <div className="mb-6 grid grid-cols-3 gap-3">
              ...
              />
              <StatCard
                icon={<Briefcase weight="regular" className="h-4 w-4 text-success" />}
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            <Badge
                              ...
                              className={cn(
                                "shrink-0 text-[10px]",
                                d.status === "COMPLETED" && "border-success/30 bg-success/5 text-success"
                              )}
                            >
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0 flex-1">
                          <div className="mb-1.5 flex flex-wrap items-center gap-1.5">
                            ...
                            {r.isUrgent && (
                              <Badge className="bg-destructive/10 text-destructive hover:bg-destructive/10 text-[10px]">
                                Shoshilinch
                              </Badge>
                            )}
                            <Badge
                              ...
                              className={cn(
                                "text-[10px]",
                                r.status === "OPEN" && "border-success/30 bg-success/5 text-success"
                              )}
                            >
