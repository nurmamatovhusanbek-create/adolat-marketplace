        ...
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-border bg-background/95 px-4 py-3 backdrop-blur">
          ...
          <div className="flex items-center gap-2">
            ...
            {user?.id && editorDraftId && (
              <Badge variant="outline" className="hidden items-center gap-1 text-success sm:flex">
    ...
    <div className={colSpan}>
      ...
      {field.type === "textarea" ? (
        <Textarea
          ...
          rows={3}
          className={`mt-1.5 resize-none ${error ? "border-destructive/50" : ""}`}
        />
      ) : field.type === "select" ? (
        <Select value={value} onValueChange={onChange}>
          <SelectTrigger className={`mt-1.5 ${error ? "border-destructive/50" : ""}`}>
        ...
        <Input
          ...
          maxLength={field.maxLength}
          className={`mt-1.5 ${error ? "border-destructive/50" : ""}`}
        />
      )}
          ...
          return (
            <span
              ...
              className={`mx-1 inline-block min-w-32 rounded px-1 ${
                val ? "border-b-2 border-success bg-success/5 font-medium" : "border-b border-dashed border-muted-foreground/40 bg-muted/50 text-muted-foreground"
              }`}
            >
