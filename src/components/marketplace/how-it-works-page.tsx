        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <Card className="border-border p-6">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-md bg-success/5 text-success">
            ...
            <Button
              ...
              className="mt-6 w-full gap-1 border-success/20 bg-success/5 text-success hover:bg-success/10"
            >
              Hujjatlarga o'tish
