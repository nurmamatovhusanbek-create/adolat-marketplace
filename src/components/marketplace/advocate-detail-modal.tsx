            ...
            <div className="relative bg-gradient-to-br from-primary to-primary/80 p-6 text-primary-foreground">
              ...
              <div className="relative flex items-start gap-4">
                <div className="relative shrink-0">
                  ...
                  />
                  {adv.online && (
                    <span className="absolute -bottom-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full border-2 border-primary bg-success/50 text-[10px] font-bold text-white">
                      ●
                    </span>
                  )}
                </div>
              ...
              <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
                {(adv.expertise ?? []).map((e) => (
                  <div key={e} className="flex items-center gap-2 text-sm">
                    <CheckCircle weight="regular" className="h-4 w-4 shrink-0 text-success" />
