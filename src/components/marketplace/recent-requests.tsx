              ...
              >
                      ...
                      <Badge variant="outline" className="text-[11px]">
                        {req.clientType === "business" ? (
                          <span className="flex items-center gap-1">
                            <BuildingOffice weight="regular" className="h-2.5 w-2.5" /> Biznes
                          </span>
                        ) : (
                          <span className="flex items-center gap-1">
                            <User weight="regular" className="h-2.5 w-2.5" /> Jismoniy
                          </span>
                        )}
                      </Badge>
                    </div>
                ...
                {req.budgetMin && req.budgetMax && (
                  <div className="flex items-center gap-2 rounded-md border border-trust-verified/20 bg-trust-verified/5 px-3 py-1.5 text-xs">
                    <Wallet weight="regular" className="h-4 w-4 text-trust-verified" />
