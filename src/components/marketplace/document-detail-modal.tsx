              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div className="flex-1 pr-6">
                  <div className="mb-2 flex flex-wrap items-center gap-1.5">
                    ...
                    {doc.isFree && (
                      <Badge className="bg-success text-white text-[11px] hover:bg-success">
                        Bepul
                      </Badge>
                    )}
                    {doc.isNew && (
              ...
              <div className="rounded-md border-2 border-primary/20 bg-primary/5 p-5">
                <div className="flex flex-wrap items-end justify-between gap-3">
                  <div>
                    ...
                    {doc.isFree ? (
                      <div className="mt-1 flex items-center gap-2 text-3xl font-bold text-success">
...
function Feature({ text }: { text: string }) {
  return (
    <li className="flex items-start gap-2 text-sm text-foreground/90">
      <CheckCircle weight="regular" className="mt-0.5 h-4 w-4 shrink-0 text-success" />
      <span>{text}</span>
    </li>
  );
}
