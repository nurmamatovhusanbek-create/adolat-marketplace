            ...
            <div className="relative">
              <Card className="border-border p-5 shadow-xl">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <Badge className="bg-success/10 text-success hover:bg-success/10">+18%</Badge>
                </div>

                <div className="grid grid-cols-2 gap-3">
                  <MiniStat icon={Users} value="32" label="Yangi mijozlar" color="text-success" />
                  ...
                  <MiniStat icon={Wallet} value="9.4 mln" label="Daromad" color="text-success" />
                </div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      >
                        ...
                        <span className="font-semibold text-success">{r.budget}</span>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        <Card className="border-border p-6 sm:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="rounded-lg bg-secondary/50 p-3 text-xs text-muted-foreground">
              <CheckCircle weight="regular" className="mr-1 inline h-3.5 w-3.5 text-success" />
