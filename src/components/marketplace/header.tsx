      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleQuickSearch} className="ml-auto hidden flex-1 items-center lg:flex max-w-xs">
          <div className="relative w-full group">
            <MagnifyingGlass className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-accent" />
            <Input
              value={quickSearch}
