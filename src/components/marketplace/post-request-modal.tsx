        ...
        {submitted ? (
          <div className="flex flex-col items-center gap-4 p-8 text-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-emerald-100">
              <CheckCircle weight="regular" className="h-9 w-9 text-emerald-600" />
            </div>
              ...
              <div className="mt-4 flex items-center gap-1.5">
                {STEPS.map((s, i) => (
                  <div key={s} className="flex flex-1 items-center gap-1.5">
                    ...
                    >
                      {i < step ? <CheckCircle weight="regular" className="h-4 w-4" /> : i + 1}
                    </div>
                    <span
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <TypeCard
                        ...
                        icon={<User weight="regular" className="h-5 w-5" />}
                        title="Advokat kerak"
                      ...
                      <TypeCard
                        ...
                        icon={<BuildingOffice weight="regular" className="h-5 w-5" />}
                        title="Hujjat kerak"
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between rounded-lg border border-amber-200 bg-amber-50 p-3">
                    <div className="flex items-center gap-2">
                      <Fire weight="fill" className="h-4 w-4 text-amber-700" />
                      <div>
              ...
              {step === 2 && (
                <div className="space-y-5">
                  ...
                  <div className="rounded-lg bg-secondary/50 p-3 text-xs text-muted-foreground">
                    <Clock weight="regular" className="mr-1 inline h-3.5 w-3.5 text-primary" />
